...
class KategoriTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('kategori')->insert(['kategori_adi' => 'Tv ve Ses Sistemleri', 'slug' =>
            'tv-ses-sistemleri','ust_id'=>$id]);
        ...
        DB::table('kategori')->insertGetId(['kategori_adi' => 'Edebiyat', 'slug' => 'edebiyat','ust_id'=>$id]);
        DB::table('kategori')->insertGetId(['kategori_adi' => 'Çocuk', 'slug' => 'cocuk','ust_id'=>$id]);
        DB::table('kategori')->insertGetId(['kategori_adi' => 'Bilgisayar', 'slug' => 'bilgisayar','ust_id'=>$id]);
        DB::table('kategori')->insertGetId(['kategori_adi' => 'Sınavlara Hazırlık', 'slug' => 'sinalara-hazirlik'
            ,'ust_id'=>$id]);
