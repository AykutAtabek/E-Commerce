<div class="list-group">
    ...
    <a href="{{route('yonetim.kategori')}}" class="list-group-item collapsed" data-target="#submenu1" data-toggle="collapse"
       data-parent="#sidebar"><span class="fa fa-fw fa-dashboard"></span> Kategoriler<span class="caret
        arrow"></span></a>
